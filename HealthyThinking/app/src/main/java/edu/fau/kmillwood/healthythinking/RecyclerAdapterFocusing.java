...
public class RecyclerAdapterFocusing extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private String[] positiveFocusingText = {
            ...
            "Living a healthy lifestyle can help you on your journey to healthy thinking. Exercising throughout the week, eating a balanced diet, and getting enough rest will put you in a good mood which makes it easier to look at things with a balanced outlook.",
